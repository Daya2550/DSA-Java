...
public class parent {
    ...
    public void takeInput() {
        ...
        System.out.print("Enter the size of array (max 100): ");
        size = sc.nextInt();
        if (size > 100) {
            System.out.println("Size limit exceeded! Setting size to 100.");
            size = 100;
        }
    ...
    public void ToSamearraay() {
        ...
        if (size + newSize > 100) {
            System.out.println("Total size limit (100) exceeded! adding only what fits.");
            newSize = 100 - size;
        }
